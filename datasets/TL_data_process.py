...
class TL_Process(object):
    ...
    def data_prepare(self, test=False):
        if test:
            ...
            val_tgt_pd = pd.read_pickle(self.data_dir + 'Tgt_val_' + self.data_file + '.pkl')
            ...
            val_tgt_dataset = dataset(anno_pd=val_tgt_pd, data_dir=self.data_dir, transform=data_transforms['Tgt_val'])

            return train_src_dataset, train_tgt_dataset, val_tgt_dataset
