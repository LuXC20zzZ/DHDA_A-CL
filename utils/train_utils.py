...
class train_utils(object):
    ...
    def setup(self):
        ...
        self.datasets = {}
        self.datasets['Src_train'], self.datasets['Tgt_train'], self.datasets['Tgt_val'] = Dataset(args.data_dir, args.data_file).data_prepare()
        ...
        self.dataloaders = {x: torch.utils.data.DataLoader(self.datasets[x],
                            ...
                            for x in ['Src_train', 'Tgt_train', 'Tgt_val']}
                    ...
                    with torch.set_grad_enabled(phase == 'train'):
                        ...
                        if args.model_name == 'DHDA_ACL':
                            if phase == 'train':
                                ...
                                _, out_CL_t, out_CL_t_, _, _, logits = self.model(inputs, alpha=alpha)
